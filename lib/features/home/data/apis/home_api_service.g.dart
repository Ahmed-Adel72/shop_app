...
class _AddAndRemoveFavorite implements AddAndRemoveFavorite {
  _AddAndRemoveFavorite(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
  ...
  Future<AddFavoriteResponseBody> addAndRemoveFavorite(
    ...
    _data.addAll(addFavoriteRequestBody.toJson());
    final _options = _setStreamType<AddFavoriteResponseBody>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddFavoriteResponseBody _value;
    try {
      _value = AddFavoriteResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
...
class _AddAndRemoveCart implements AddAndRemoveCart {
  _AddAndRemoveCart(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<AddToCartResponseBody> addAndRemoveCart(
    ...
    final _options = _setStreamType<AddToCartResponseBody>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddToCartResponseBody _value;
    try {
      _value = AddToCartResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
...
class _GetCategories implements GetCategories {
  _GetCategories(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
